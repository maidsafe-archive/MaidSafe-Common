...
ELSEIF(DEFAULT_THIRD_PARTY_ROOT)
  SET(GMOCK_ROOT_DIR ${DEFAULT_THIRD_PARTY_ROOT})
ENDIF()

IF(MSVC)
  SET(GMOCK_LIBPATH_SUFFIX third_party_libs/build_googlemock/Release)
ELSE()
  SET(GMOCK_LIBPATH_SUFFIX third_party_libs/build_googlemock)
ENDIF()

FIND_LIBRARY(Gmock_LIBRARY_RELEASE NAMES gmock PATHS ${GMOCK_LIB_DIR} ${GMOCK_ROOT_DIR} PATH_SUFFIXES ${GMOCK_LIBPATH_SUFFIX} NO_SYSTEM_ENVIRONMENT_PATH NO_CMAKE_SYSTEM_PATH)
IF(MSVC)
  SET(GMOCK_LIBPATH_SUFFIX third_party_libs/build_googlemock/Debug)
  FIND_LIBRARY(Gmock_LIBRARY_DEBUG NAMES gmock PATHS ${GMOCK_LIB_DIR} ${GMOCK_ROOT_DIR} PATH_SUFFIXES ${GMOCK_LIBPATH_SUFFIX} NO_SYSTEM_ENVIRONMENT_PATH NO_CMAKE_SYSTEM_PATH)
ENDIF()

FIND_PATH(Gmock_INCLUDE_DIR gmock/gmock.h PATHS ${GMOCK_INC_DIR} ${GMOCK_ROOT_DIR}/third_party_libs/build_googlemock/include NO_SYSTEM_ENVIRONMENT_PATH NO_CMAKE_SYSTEM_PATH)
