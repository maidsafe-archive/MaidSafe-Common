...
class Sqlite3WrapperBenchmark {
 ...
 private:
  ...
  void EndpointStringsConcurrentInsertions();
  void EndpointStringsConcurrentDeletes();

  void AddRemoveEndpointStrings(sqlite::Database& database,
  ...
  void KeyValueConcurrentInsertions();
