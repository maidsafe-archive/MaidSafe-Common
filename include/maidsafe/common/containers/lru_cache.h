...
/*
  ...
  for keys already seen. USers can set the capacity, time_to_live or both allowing a cahce that will
  not hold data too long or stay full if it not being accessed frequently. This should
  allow the cache to not hold stale information at teh cost of a ckeck every time we add that looks
