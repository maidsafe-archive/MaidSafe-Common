...
FUNCTION(RUN_TEST_ONCE MODULE_NAME)
  ...
  SET(CTEST_CONFIGURE_COMMAND "${BASIC_CTEST_CONFIGURE_COMMAND} \"${CTEST_SOURCE_DIRECTORY}\" -DCOVERAGE=ON -DMEMORY_CHECK=OFF")
  ...
  IF(${DASHBOARD_MODEL} MATCHES Nightly AND CTEST_MEMORYCHECK_COMMAND)
    ...
    SET(CTEST_CONFIGURE_COMMAND "${BASIC_CTEST_CONFIGURE_COMMAND} \"${CTEST_SOURCE_DIRECTORY}\" -DCOVERAGE=OFF -DMEMORY_CHECK=ON")
    CTEST_CONFIGURE()
    CTEST_BUILD()
    CTEST_MEMCHECK()
    SET(CTEST_CONFIGURE_COMMAND "${BASIC_CTEST_CONFIGURE_COMMAND} \"${CTEST_SOURCE_DIRECTORY}\" -DMEMORY_CHECK=OFF")
    CTEST_CONFIGURE()
