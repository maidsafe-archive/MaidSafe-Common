...
class RudpCategory : public boost::system::error_category {
 public:
  virtual const char* name() const MAIDSAFE_NOEXCEPT;
  virtual std::string message(int error_value) const MAIDSAFE_NOEXCEPT;
  //virtual boost::system::error_condition default_error_condition(int error_value) const MAIDSAFE_NOEXCEPT;
};
