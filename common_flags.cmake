...
target_compile_definitions(maidsafe_common
  PUBLIC
    ...
    $<$<NOT:$<BOOL:${MSVC}>>:ASIO_HAS_VARIADIC_TEMPLATES BOOST_ASIO_HAS_VARIADIC_TEMPLATES>
#    ASIO_NO_DEPRECATED
#    BOOST_ASIO_NO_DEPRECATED
    $<$<OR:$<CXX_COMPILER_ID:Clang>,$<CXX_COMPILER_ID:AppleClang>>:
        ASIO_HAS_CLANG_CXX
        BOOST_ASIO_HAS_CLANG_CXX
    >
...
target_compile_options(maidsafe_common
  PUBLIC
    $<$<BOOL:${MSVC}>:
        ...
        /bigobj  # Increases the number of sections that an object file can contain from 65,536 to 4,294,967,296.
        $<$<CONFIG:Release>:
